...
export default function DomeGallery({
  ...
  useGesture(
    {
      onDragStart: ({ event }) => {
        ...
        const pointerType = evt.pointerType as string;
        pointerTypeRef.current = (pointerType === 'touch' || pointerType === 'pen' ? pointerType : 'mouse');
  ...
  return (
    <>
      ...
      <div
        ref={rootRef}
        className="sphere-root relative w-full min-h-[110vh]"
        style={
          {
            '--segments-x': segments,
            '--segments-y': segments,
                  ...
                  style={
                    {
                      ...
                      left: '-999px',
                      right: '-999px'
                    } as React.CSSProperties & { '--offset-x': number; '--offset-y': number; '--item-size-x': number; '--item-size-y': number }
                  }
                >
                  <div
