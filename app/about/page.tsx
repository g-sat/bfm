...
const processSteps = [
  {
    ...
    detail: "We embed with your teams, absorbing brand mythologies, audience rituals, and cultural context before sketching a single frame.",
  },
  {
    title: "02. Translate & choreograph",
    detail: "Narrative strategists, directors, and technologists co-design a multisensory score that aligns message, motion, light, and sound.",
  },
  {
    title: "03. Prototype & rehearse",
    detail: "We build playable simulations, invite audiences into the space, and iterate on every beat with live data and emotional feedback.",
  },
  {
    title: "04. Launch & evolve",
    detail: "Deployment crews orchestrate the opening sequence, while analytics loops keep the experience learning and adapting post-launch.",
  },
];
...
export default function AboutPage() {
  return (
    <main className="relative min-h-screen bg-[#05030F] text-white">
      ...
      <motion.div
        className="pointer-events-none absolute inset-x-0 top-0 h-[30vh] bg-[radial-gradient(circle_at_50%_-10%,rgba(108,99,255,0.18),transparent_60%)]"
        animate={{ opacity: [0.35, 0.55, 0.35], y: [0, -12, 0] }}
        transition={{ duration: 24, repeat: Infinity, ease: "easeInOut" }}
      />
      <section className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-36 pb-24 sm:px-10 lg:px-16">
        <motion.p
        ...
        >
          <div>
            <h1 className="text-4xl font-semibold leading-tight text-white/95 sm:text-5xl lg:text-[3.6rem]">
            ...
            {capabilityCards.map((card, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col">
                  <h3 className="text-2xl font-semibold text-white/95">{card.title}</h3>
        ...
        <section className="mt-28 grid gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
          ...
          >
            ...
            <h2 className="text-3xl font-semibold text-white sm:text-4xl">A measured path from spark to spectacle</h2>
        ...
        >
          ...
          <h2 className="mt-6 text-3xl font-semibold text-white sm:text-4xl">Ready to stage a living, breathing brand world?</h2>
